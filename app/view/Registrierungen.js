                                ...
                                buttons: [
                                    {
                                        ...
                                        handler: function (btn) {
                                            ...
                                            fetch('modules/common/update.cfc?method=changeArtistApproval', {
                                                ...
                                                body: JSON.stringify({ artistID: rec.get('id'), artistMail: rec.get('email'), approved: 1, name: rec.get('name') })
                                            })
                                            .then(async (response) => {
                                        ...
                                        handler: function (btn) {
                                            ...
                                            fetch('modules/common/update.cfc?method=changeArtistApproval', {
                                                ...
                                                body: JSON.stringify({ artistID: rec.get('id'), artistMail: rec.get('email'), approved: 0, name: rec.get('name') })
                                            })
